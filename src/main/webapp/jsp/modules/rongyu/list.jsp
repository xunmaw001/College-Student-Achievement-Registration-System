...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">荣誉列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="rongyuNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="荣誉名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        荣誉类型
                                        <div class="layui-input-inline">
                                            <select name="rongyuTypesSelectSearch"  style="width: 150px;" id="rongyuTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //荣誉名称
            var rongyuNameSearchInput = $('#rongyuNameSearch');
            if( rongyuNameSearchInput != null){
                if (rongyuNameSearchInput.val() != null && rongyuNameSearchInput.val() != '') {
                    searchForm.rongyuName = $('#rongyuNameSearch').val();
                }
            }
     
                //荣誉类型
            var rongyuTypesSelectSearchInput = document.getElementById("rongyuTypesSelectSearch");
            if(rongyuTypesSelectSearchInput != null){
                var rongyuTypesIndex = rongyuTypesSelectSearchInput.selectedIndex;
                if( rongyuTypesIndex  != 0){
                    searchForm.rongyuTypes= document.getElementById("rongyuTypesSelectSearch").options[rongyuTypesIndex].value;
                }
            }
                                    getDataList();
        }
        ...
        function getDataList() {
            http("rongyu/page", "GET", {
                ...
                rongyuDelete: 1,
                //本表的
                rongyuName: searchForm.rongyuName,
                rongyuTypes: searchForm.rongyuTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //荣誉名称
            var rongyuNameCell = document.createElement('td');
            rongyuNameCell.innerHTML = item.rongyuName;
            row.appendChild(rongyuNameCell);


            //荣誉类型
            var rongyuTypesCell = document.createElement('td');
            rongyuTypesCell.innerHTML = item.rongyuValue;
            row.appendChild(rongyuTypesCell);

                //荣誉照片
            var rongyuPhotoCell = document.createElement('td');
            var rongyuPhotoImg = document.createElement('img');
            var rongyuPhotoImgValue = item.rongyuPhoto;
            if(rongyuPhotoImgValue !=null && rongyuPhotoImgValue !='' && rongyuPhotoImgValue !='null'){
                rongyuPhotoImg.setAttribute('src', rongyuPhotoImgValue);
                rongyuPhotoImg.setAttribute('height', 100);
                rongyuPhotoImg.setAttribute('width', 100);
                rongyuPhotoCell.appendChild(rongyuPhotoImg);
            }else{
                rongyuPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(rongyuPhotoCell);

                //相关文件
            var rongyuFileCell = document.createElement('td');
            if(item.rongyuFile ==null || item.rongyuFile == '' || item.rongyuFile == 'null'){
                    rongyuFileCell.innerHTML = '没有下载文件';
            }else {
                var rongyuFileFile = document.createElement('button');
                    rongyuFileFile.innerHTML = '下载';
                var rongyuFileFileAttr = "download('" + item.rongyuFile + "')"
                    rongyuFileFile.setAttribute('onclick',rongyuFileFileAttr);
                    rongyuFileCell.appendChild(rongyuFileFile);
            }
            row.appendChild(rongyuFileCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("rongyu/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addrongyu", "addrongyu");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function rongyuTypesSelectSearch() {
            var rongyuTypesSelectSearch = document.getElementById('rongyuTypesSelectSearch');
            if(rongyuTypesSelectSearch != null) {
                rongyuTypesSelectSearch.add(new Option('-请选择-',''));
                if (rongyuTypesOptions != null && rongyuTypesOptions.length > 0){
                    for (var i = 0; i < rongyuTypesOptions.length; i++) {
                            rongyuTypesSelectSearch.add(new Option(rongyuTypesOptions[i].indexName,rongyuTypesOptions[i].codeIndex));
                    }
                }
            }
        }
