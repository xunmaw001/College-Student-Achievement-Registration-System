...
<!--/Pre Loader -->
                            ...
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        院校
                                        <div class="layui-input-inline">
                                            <select name="yuanxiaoTypesSelectSearch"  style="width: 150px;" id="yuanxiaoTypesSelectSearch" class="form-control form-control-sm"
    ...
    <!-- 本表的查询条件 -->
        ...
        function setDataRow(item, number) {
            ...
            //院校
            var yuanxiaoTypesCell = document.createElement('td');
            yuanxiaoTypesCell.innerHTML = item.yuanxiaoValue;
            row.appendChild(yuanxiaoTypesCell);
