            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">论文登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="xueshengId" name="xueshengId" v-model="ruleForm.xueshengId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="lunwenUuidNumber" name="lunwenUuidNumber" class="form-control"
                                               v-model="ruleForm.lunwenUuidNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="lunwenName" name="lunwenName" class="form-control"
                                               v-model="ruleForm.lunwenName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>论文类型</label>
                                    <input style="width: 450px" id="lunwenValue" name="lunwenValue" class="form-control"
                                           v-model="ruleForm.lunwenValue" readonly>
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.lunwenContent != null && ruleForm.lunwenContent != 'null' && ruleForm.lunwenContent != '') {
            var lunwenContentUeditor = UE.getEditor('lunwenContentEditor');
                lunwenContentUeditor.ready(function () {
                    ...
                    lunwenContentUeditor.setDisabled('fullscreen');
            });
        }
    }
    ...
    function setDownloadBtn() {
        var lunwenFileUrl = "download('" + ruleForm.lunwenFile + "')";
        $("#lunwenFile").attr("onclick", lunwenFileUrl);
