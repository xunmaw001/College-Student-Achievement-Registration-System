                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6 yuanxiaoTypesDiv">
                                        <label>院校</label>
                                        <select style="width: 450px" id="yuanxiaoTypesSelect" name="yuanxiaoTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationYuanxiaotypesSelect(){
            var yuanxiaoTypesSelect = document.getElementById('yuanxiaoTypesSelect');
            if(yuanxiaoTypesSelect != null && yuanxiaoTypesOptions != null  && yuanxiaoTypesOptions.length > 0 ){
                for (var i = 0; i < yuanxiaoTypesOptions.length; i++) {
                    yuanxiaoTypesSelect.add(new Option(yuanxiaoTypesOptions[i].indexName,yuanxiaoTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(yuanxiaoTypesSelect != null && yuanxiaoTypesOptions != null  && yuanxiaoTypesOptions.length > 0 ) {
            for (var i = 0; i < yuanxiaoTypesOptions.length; i++) {
                if (yuanxiaoTypesOptions[i].codeIndex == ruleForm.yuanxiaoTypes) {//下拉框value对比,如果一致就赋值汉字
                        yuanxiaoTypesSelect.options[i].selected = true;
                }
            }
        }
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationYuanxiaotypesSelect();
