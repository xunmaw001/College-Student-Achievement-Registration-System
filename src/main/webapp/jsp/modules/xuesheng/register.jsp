...
<body style="background-image:url('/daxueshengchengguodengji/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                   ...
                                   <div class="form-group col-md-12">
                                       <label>院校</label>
                                       <select id="yuanxiaoTypesSelect" name="yuanxiaoTypes" class="form-control">
                                       </select>
                                   </div>
                                   <div class="form-group col-md-12">
                                       <label>专业</label>
