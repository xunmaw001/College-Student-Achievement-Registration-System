...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">竞赛获奖管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">竞赛获奖列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">竞赛获奖列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="jingsaiNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="竞赛名称" aria-controls="tableId">
                                        </div>
                                    </div>
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        竞赛类型
                                        <div class="layui-input-inline">
                                            <select name="jingsaiTypesSelectSearch"  style="width: 150px;" id="jingsaiTypesSelectSearch" class="form-control form-control-sm"
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //竞赛名称
            var jingsaiNameSearchInput = $('#jingsaiNameSearch');
            if( jingsaiNameSearchInput != null){
                if (jingsaiNameSearchInput.val() != null && jingsaiNameSearchInput.val() != '') {
                    searchForm.jingsaiName = $('#jingsaiNameSearch').val();
                }
            }
     
                //竞赛类型
            var jingsaiTypesSelectSearchInput = document.getElementById("jingsaiTypesSelectSearch");
            if(jingsaiTypesSelectSearchInput != null){
                var jingsaiTypesIndex = jingsaiTypesSelectSearchInput.selectedIndex;
                if( jingsaiTypesIndex  != 0){
                    searchForm.jingsaiTypes= document.getElementById("jingsaiTypesSelectSearch").options[jingsaiTypesIndex].value;
                }
            }
                                            getDataList();
        }
        ...
        function getDataList() {
            http("jingsai/page", "GET", {
                ...
                jingsaiDelete: 1,
                //本表的
                jingsaiName: searchForm.jingsaiName,
                jingsaiTypes: searchForm.jingsaiTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //竞赛名称
            var jingsaiNameCell = document.createElement('td');
            jingsaiNameCell.innerHTML = item.jingsaiName;
            row.appendChild(jingsaiNameCell);


            //竞赛类型
            var jingsaiTypesCell = document.createElement('td');
            jingsaiTypesCell.innerHTML = item.jingsaiValue;
            row.appendChild(jingsaiTypesCell);


            //竞赛地址
            var jingsaiAddressCell = document.createElement('td');
            jingsaiAddressCell.innerHTML = item.jingsaiAddress;
            row.appendChild(jingsaiAddressCell);


            //名次
            var jingsaiMingciCell = document.createElement('td');
            jingsaiMingciCell.innerHTML = item.jingsaiMingci;
            row.appendChild(jingsaiMingciCell);

                //获奖照片
            var jingsaiPhotoCell = document.createElement('td');
            var jingsaiPhotoImg = document.createElement('img');
            var jingsaiPhotoImgValue = item.jingsaiPhoto;
            if(jingsaiPhotoImgValue !=null && jingsaiPhotoImgValue !='' && jingsaiPhotoImgValue !='null'){
                jingsaiPhotoImg.setAttribute('src', jingsaiPhotoImgValue);
                jingsaiPhotoImg.setAttribute('height', 100);
                jingsaiPhotoImg.setAttribute('width', 100);
                jingsaiPhotoCell.appendChild(jingsaiPhotoImg);
            }else{
                jingsaiPhotoCell.innerHTML = "暂无图片";
            }
            row.appendChild(jingsaiPhotoCell);

                //相关文件
            var jingsaiFileCell = document.createElement('td');
            if(item.jingsaiFile ==null || item.jingsaiFile == '' || item.jingsaiFile == 'null'){
                    jingsaiFileCell.innerHTML = '没有下载文件';
            }else {
                var jingsaiFileFile = document.createElement('button');
                    jingsaiFileFile.innerHTML = '下载';
                var jingsaiFileFileAttr = "download('" + item.jingsaiFile + "')"
                    jingsaiFileFile.setAttribute('onclick',jingsaiFileFileAttr);
                    jingsaiFileCell.appendChild(jingsaiFileFile);
            }
            row.appendChild(jingsaiFileCell);


            //获奖时间
            var huojiangTimeCell = document.createElement('td');
            huojiangTimeCell.innerHTML = item.huojiangTime;
            row.appendChild(huojiangTimeCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("jingsai/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addjingsai", "addjingsai");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function jingsaiTypesSelectSearch() {
            var jingsaiTypesSelectSearch = document.getElementById('jingsaiTypesSelectSearch');
            if(jingsaiTypesSelectSearch != null) {
                jingsaiTypesSelectSearch.add(new Option('-请选择-',''));
                if (jingsaiTypesOptions != null && jingsaiTypesOptions.length > 0){
                    for (var i = 0; i < jingsaiTypesOptions.length; i++) {
                            jingsaiTypesSelectSearch.add(new Option(jingsaiTypesOptions[i].indexName,jingsaiTypesOptions[i].codeIndex));
                    }
                }
            }
        }
