    ...
    private static final long serialVersionUID = 1L;
		...
		*/
		...
		//级联表 xuesheng
			...
			* 院校
			*/
			private Integer yuanxiaoTypes;
				/**
				* 院校的值
				*/
				private String yuanxiaoValue;
			/**
			* 专业
			*/
			...
			*/
			public void setXiangmuYesnoValue(String xiangmuYesnoValue) {
				...
				//级联表的get和set xuesheng
					...
					* 获取： 院校
					*/
					public Integer getYuanxiaoTypes() {
						return yuanxiaoTypes;
					}
					/**
					* 设置： 院校
					*/
					public void setYuanxiaoTypes(Integer yuanxiaoTypes) {
						this.yuanxiaoTypes = yuanxiaoTypes;
					}
						...
						* 获取： 院校的值
						*/
						public String getYuanxiaoValue() {
							return yuanxiaoValue;
						}
						/**
						* 设置： 院校的值
						*/
						public void setYuanxiaoValue(String yuanxiaoValue) {
							this.yuanxiaoValue = yuanxiaoValue;
						}
