...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //审核时间
            var xiangmuShenheTimeCell = document.createElement('td');
            xiangmuShenheTimeCell.innerHTML = item.xiangmuShenheTime;
            row.appendChild(xiangmuShenheTimeCell);
    ...
    //查询当前表搜索条件所有列表
            ...
            function xiangmuYesnoTypesShenhe() {
                ...
                if (mymessage == true) {
                    ...
                    if($("#xiangmuYesnoTypes option:selected").val() == 2 || $("#xiangmuYesnoTypes option:selected").val() ==3){
                    ...
                    httpJson("xiangmu/shenhe", "POST", data, (res) => {
                        if(res.code == 0){
                            alert('审核成功');
                            getDataList();
                        }else{
