                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="xueshengId" name="xueshengId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6 xiangmuFileDiv">
                                        <label>项目相关文件</label>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                ...
                xiangmuFile: "项目相关文件不能为空",
                xiangmuContent: "项目内容不能为空",
                xiangmuYesnoTypes: "审核状态不能为空",
                xiangmuYesnoText: "审核意见不能为空",
                xiangmuShenheTime: "审核时间不能为空",
            }
        }).form();
    }
    ...
    function dateTimePick() {
        ...
        var xiangmuShenheTime = laydate.render({
            elem: '#xiangmuShenheTime-input'
            ,type: 'datetime'
        });
    }
    ...
    <!--  当前表的数据回显  -->
        ...
        $("#xiangmuShenheTime-input").val(ruleForm.xiangmuShenheTime);
